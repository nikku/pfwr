...
When you really want to get the point across then there is plenty of room to tell a story - any story. Just be clear that folks likely don't read the content. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Got it?
...
// we validate first time apperance - special handling
if (isFirstTime(visit)) {
  hello();
} else {
  welcomeBack();
